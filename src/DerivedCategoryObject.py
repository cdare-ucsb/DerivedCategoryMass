...
class DerivedCategoryObject():
    ...
    def __init__(self, catagory, string = "0", chern_character = None):
        ...
        self.chern_character = chern_character ## The Chern Character of the derived category object. This is optional and can be set later, especially when the object is put into a distinguished triangle with two objects whose Chern characters are known.
        
        self.string = string ## A string representation / label of the derived category object.
