...
def plot_sph_twist():
    ...
    try:
        ...
        plot_json = compute_plot_data(line_bundle_1, line_bundle_2)
        chain_complex_data = compute_chain_complex_data(line_bundle_1, line_bundle_2)
        
        
        return render_template('plot.html', plot_json=plot_json, chain_complex=chain_complex_data)
...
def compute_plot_data(line_bundle_1, line_bundle_2):
...
def compute_chain_complex_data(line_bundle_1, line_bundle_2):
